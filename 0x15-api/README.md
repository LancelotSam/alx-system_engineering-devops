...
GitHub repository: alx-system_engineering-devops
Directory: 0x15-api
OAOAOAFile: 1-export_to_CSV.py
OAOAOA     
2. Export to JSON
mandatory
OAOAOAScore: 0.0% (Checks completed: 0.0%)
OAOAOAUsing what you did in the task #0, extend your Python script to export data in the JSON format.
OAOAOA
Requirements:
OAOAOA
OAOAOARecords all tasks that are owned by this employee
OAOAOAFormat must be: { "USER_ID": [{"task": "TASK_TITLE", "completed": TASK_COMPLETED_STATUS, "username": "USERNAME"}, {"task": "TASK_TITLE", "completed": TASK_COMPLETED_STATUS, "username": "USERNAME"}, ... ]}
File name must be: USER_ID.json
Example:

OAOAOAsylvain@ubuntu$ python3 2-export_to_JSON.py 2
